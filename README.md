...
It also replaces Foundry's active `TOKEN.Adjectives` pool with a custom set of physical adjectives, allowing more descriptive token names without editing `fr-core`.
